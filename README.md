...
TODO add dunstify messages
TODO fill up space of window

Bluetooth control TUI in Go using Bubble Tea, using bluetoothctl.
...
And inspired by the shell script by Jesse Mirabel <github.com/sejjy>


Hopefully going towards the primagen's navigation
